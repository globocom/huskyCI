...
func (mR *MongoRequests) FindOneDBRepository(mapParams map[string]interface{}) (repository.Repository, error) {
	repositoryResponse := repository.Repository{}
...
func (mR *MongoRequests) FindOneDBSecurityTest(mapParams map[string]interface{}) (securitytest.SecurityTest, error) {
...
func (mR *MongoRequests) FindAllDBRepository(mapParams map[string]interface{}) ([]repository.Repository, error) {
	repositoryQuery := []bson.M{}
	for k, v := range mapParams {
		repositoryQuery = append(repositoryQuery, bson.M{k: v})
	}
...
func (mR *MongoRequests) FindAllDBSecurityTest(mapParams map[string]interface{}) ([]securitytest.SecurityTest, error) {
	securityTestQuery := []bson.M{}
	for k, v := range mapParams {
		securityTestQuery = append(securityTestQuery, bson.M{k: v})
	}
...
func (mR *MongoRequests) InsertDBRepository(repository repository.Repository) error {
...
func (mR *MongoRequests) InsertDBSecurityTest(securityTest securitytest.SecurityTest) error {
...
func (mR *MongoRequests) UpsertOneDBSecurityTest(mapParams map[string]interface{}, updatedSecurityTest securitytest.SecurityTest) (interface{}, error) {
	securityTestQuery := []bson.M{}
	for k, v := range mapParams {
		securityTestQuery = append(securityTestQuery, bson.M{k: v})
	}
